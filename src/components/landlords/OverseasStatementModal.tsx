    ...
    <div className="space-y-6 text-slate-800">
      ...
      <Card className="p-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          {/* Quick Landlord Selector */}
          <div className="flex items-center gap-2">
            {payouts.map(p => (
              <Button
                key={p.id}
                size="sm"
                variant={selectedPayout.id === p.id ? 'default' : 'outline'}
      ...
      <Card className="p-6 space-y-5">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-200">
          <div className="flex items-center gap-2 text-sm text-slate-600">
            ...
            <span>Landlord: <strong className="text-slate-900 font-bold">{selectedPayout.landlordName}</strong> ({selectedPayout.landlordCountry})</span>
          </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-7 text-slate-800 shadow-2xs space-y-6">
          
          {/* Statement Header */}
          <div className="flex items-start justify-between border-b border-slate-200 pb-4">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-2xl font-black text-slate-900">PROPMAK</span>
            ...
            <div className="text-right">
              <span className="text-sm font-mono font-bold text-slate-900 block">Ref: STMT-{selectedPayout.id.toUpperCase()}</span>
              <span className="text-sm text-slate-900 font-bold">{selectedPayout.period}</span>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="p-4 rounded-xl bg-white border border-slate-200 grid grid-cols-1 sm:grid-cols-2 gap-3 text-slate-800">
            ...
            <Table>
              ...
              <TableBody>
                <TableRow className="bg-emerald-50/60 font-bold text-emerald-950">
                  ...
                  <TableCell className="text-right text-base font-extrabold text-emerald-700">
          ...
          <div className="p-5 rounded-xl bg-white border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
            ...
            <div className="bg-slate-50 px-5 py-3 rounded-xl border border-slate-200 text-right shadow-2xs">
          ...
          {/* Audit Footer */}
          <div className="pt-2 border-t border-slate-200 flex items-center justify-between text-sm text-slate-600">
